...
$snippets[1]->fromArray(array(
    ...
    'snippet' => getSnippetContent($sources['snippets'].'snippet.taglister.php'),
),'',true,true);
...
$snippets[2]->fromArray(array(
    ...
    'snippet' => getSnippetContent($sources['snippets'].'snippet.tolinks.php'),
),'',true,true);
...
$snippets[3]->fromArray(array(
    ...
    'snippet' => getSnippetContent($sources['snippets'].'snippet.getresourcetagfast.php'),
),'',true,true);
...
$snippets[4]->fromArray(array(
    'id' => 4,
    'name' => 'CountTags',
    'snippet' => getSnippetContent($sources['snippets'].'snippet.counttags.php'),
),'',true,true);
unset($properties);
return $snippets;